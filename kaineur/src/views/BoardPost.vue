...
import Card from "@/components/AppButton.vue";
import Overlay from "@/components/OverlayPost.vue";
import Popup from "@/components/PopupPost.vue";
...
.input-new-list {
  ...
  padding: 10px;
  border-radius: 5px;
  background-color: rgba(202, 23, 47, 0.5);
  min-width: 260px;
}
